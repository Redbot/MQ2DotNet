...
tags:
  - plugin
resource_link: "https://www.redguides.com/community/resources/mq2dotnet.1209/"
support_link: "https://www.redguides.com/community/threads/net-c-plugin-and-program-api.65606/"
repository: "https://github.com/projecteon/MQ2DotNet"
config: "MQ2DotNet.ini"
authors: "alynel, projecteon"
tagline: ".NET / C# Plugin and Program API"
---
...
<a href="cmd-netrun/">
{% 
  include-markdown "projects/mq2dotnet/cmd-netrun.md" 
...
:    {% include-markdown "projects/mq2dotnet/cmd-netrun.md" 
     ...
     %} {{ readMore('projects/mq2dotnet/cmd-netrun.md') }}

<a href="cmd-netend/">
{% 
  include-markdown "projects/mq2dotnet/cmd-netend.md" 
  start="<!--cmd-syntax-start-->" 
  end="<!--cmd-syntax-end-->" 
%}
</a>
:    {% include-markdown "projects/mq2dotnet/cmd-netend.md" 
        ...
        trailing-newlines=false 
     %} {{ readMore('projects/mq2dotnet/cmd-netend.md') }}

<a href="cmd-netplugin/">
{% 
  include-markdown "projects/mq2dotnet/cmd-netplugin.md" 
  start="<!--cmd-syntax-start-->" 
  end="<!--cmd-syntax-end-->" 
%}
</a>
:    {% include-markdown "projects/mq2dotnet/cmd-netplugin.md" 
        ...
        trailing-newlines=false 
     %} {{ readMore('projects/mq2dotnet/cmd-netplugin.md') }}
